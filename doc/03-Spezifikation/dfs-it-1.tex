...
Wie zu sehen ist, konnten alle Axiome bewiesen werden. Dabei wurde bei den Axiomen 2 bis 4 auf den Terminationsbeweis zurück gegriffen. In den Tabellen \ref{tab:dfs-it-1-stat} bis \ref{tab:dfs-it-1-lemma} sind noch einmal die bei den Beweisen verwendeten Beweisschritte aufgeführt.
