...
Zunächst werde die Spezifikation \texttt{union\_bool\_graph} betrachtet, welche die notwendigen Pakete der Graphenbibliothek zusammenfasst. Folgenden die verwendete Spezifikation:
...
Auch hier sei wieder auf die verwendeten Beweisschritte hingewiesen, welche in den Tabellen \ref{tab:digraph-path-stat} bis \ref{tab:digraph-path-lemma} aufgeführt sind.
