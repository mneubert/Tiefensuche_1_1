\section{Spezifikation \texttt{digraph-dfs-proc}}
...
Die Spezifikation erweitert hierbei die vorhandenen Spezifikationen digraph-basic sowie union\_bool\_graph, welche Hilfssätze enthalten und im Abschnitt \ref{sec:digraph-path} erläutert werden.
